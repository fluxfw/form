...
export class FluxInputElement extends HTMLElement {
    ...
    async setDisabled(disabled) {
        ...
        for (const flux_form_element of Array.from(this.#container_element.querySelectorAll("[data-form]"))) {
    ...
    get value() {
        ...
        switch (true) {
            ...
            case this.#type === INPUT_TYPE_ENTRIES:
                return Array.from(this.#container_element.querySelectorAll("[data-form]")).map(flux_form_element => flux_form_element.values);
    ...
    async #addEntry(values = null, update_entries = null) {
        ...
        await flux_form_element.setValues(
            values
        );
...
export const FLUX_INPUT_ELEMENT_TAG_NAME = "flux-input";

customElements.define(FLUX_INPUT_ELEMENT_TAG_NAME, FluxInputElement);
